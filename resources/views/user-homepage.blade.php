...
<body>
    <header>
      ...
      <main>
        <section class="bg-white shadow-2xl pt-8">
          <div class="grid py-8 px-5 mx-auto max-w-screen-xl lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
              <div class="place-self-center mr-auto lg:col-span-7">
                  ...
                  <p class="mb-6 max-w-2xl font-medium text-gray-500 lg:mb-8 md:text-lg lg:text-xl ">
                    An online platform for users to explore the organization's mission, discover volunteer opportunities, and learn about impactful projects, fostering a community committed to positive change.</p>
        ...
        <section class="bg-gray-200 m-10 rounded-lg shadow-xl">
      ...
      <section class ="flex flex-wrap justify-center py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6 ">
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6 flex text-center ">
            <h2 class="mb-4 text-4xl lg:text-5xl  font-extrabold text-green-900">News</h2>
        </div>
      </section>
      ...
      <section class ="flex flex-wrap justify-center mx-auto">
          <div class="container mx-auto px-4 ">
            <div class="flex justify-between items-center">
              ...
              <a href="" class="lg:text-xl text-lg font-semibold text-blue-500 ">Show More</a>
            </div> 
              <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-0">
                <div class="bg-white rounded-lg overflow-hidden w-11/12">
                  <a href="">
                  <img class="w-full h-48 object-cover rounded-xl" src="../images/download.jpeg" alt="News 1">
                  <div class="p-4">
                    <h3 class="text-lg font-semibold">Ini Judul Berita</h3>
                    <p class="text-gray-500 mb-5">8 Mei 2024</p>
                  </a>
                  </div>
                </div>
                <div class="bg-white rounded-lg overflow-hidden shadow-md w-11/12">
                  <a href="">
                  <img class="w-full h-48 object-cover" src="../images/download.jpeg" alt="News 1">
                  <div class="p-4">
                    <h3 class="text-lg font-semibold">Ini Judul Berita</h3>
                    <p class="text-gray-500 mb-5">8 Mei 2024</p>
                  </a>
                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-md w-11/12">
                  ...
                  <div class="p-4">
                    <h3 class="text-lg font-semibold">Ini Judul Berita</h3>
                    <p class="text-gray-500">8 Mei 2024</p>
                  </a>
                  </div>
                </div>
                <div class="bg-white rounded-lg overflow-hidden shadow-md w-11/12">
      ...
      <section class ="flex flex-wrap justify-center mx-auto py-8">
