                    ...
                    <div class="xl:container mx-0 px-3 sm:px-4 xl:px-2">
                        <div class="flex flex-row flex-wrap">
                            ...
                            >
                                    ...
                                    <div class="mt-4 pb-2 flex justify-between items-center">
                                        <h3 class="text-gray-500 text-sm font-semibold ">
                                            Amaryllis - {{ $article->created_at }}
                                            @auth   
                                                @if(auth()->user()->hasVerifiedEmail())
                                            @livewire('bookmark-article', ['article' => $article])
                                                @endif
                                            @endauth
                                        </h3>
                                    </div>
                                    <div class="mx-auto text-center w-full">
                                        <img src="{{ $article->image }}" alt="Avatar"  class="rounded-lg w-full h-[300px]" />
                                    </div>
                                ...
                                @livewire('random-article' ,['slug' => $article->slug])
